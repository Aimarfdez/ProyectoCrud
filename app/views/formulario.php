    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <?php if (file_exists("app/uploads/" . $cli->id . ".jpg")): ?>
                    <img src="app/uploads/<?= $cli->id ?>.jpg" alt="Foto del cliente" width="100">
                <?php elseif (file_exists("app/uploads/" . $cli->id . ".png")): ?>
                    <img src="app/uploads/<?= $cli->id ?>.png" alt="Foto del cliente" width="100">
                <?php endif; ?>
            </td>
        </tr>
    </table>
